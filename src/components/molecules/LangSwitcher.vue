<template>
    <div class="w-fit bg-tertiary dark:bg-primary-light-dark text-white border-tertiary dark:border-primary-light-dark border-4 rounded-4xl relative" role="switch"
